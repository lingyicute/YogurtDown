...
static partial class YogurtDownUtil
{
    public static async Task CheckUpdateAsync()
    {
        try
        {
            ...
            string redirectUrl = await GetWebLocationAsync("https://github.com/lingyicute/YogurtDown/releases/latest");
            string latestVer = redirectUrl.Replace("https://github.com/lingyicute/YogurtDown/releases/tag/", "");
    ...
    public static bool CheckFFmpegDOVI()
    {
        try
        {
            var process = new Process
            {
                ...
                {
                    FileName = YogurtDownMuxer.FFMPEG,
                    Arguments = "-version",
