...
public static class DanmakuUtil
{
    ...
    public static async Task SaveAsAssAsync(DanmakuItem[] danmakus, string outputPath)
    {
        ...
        sb.AppendLine("Script Updated By: YogurtDown(https://github.com/lingyicute/YogurtDown)");
        ...
        sb.AppendLine($"Style: YOGURTDOWN_Style, 黑体, {FONT_SIZE}, &H00FFFFFF, &H00FFFFFF, &H00000000, &H00000000, 0, 0, 0, 0, 100, 100, 0.00, 0.00, 1, 2, 0, 7, 0, 0, 0, 0");
        ...
        foreach (DanmakuItem danmaku in danmakus)
        {
            ...
            sb.AppendLine($"Dialogue: 2,{danmaku.StartTime},{danmaku.EndTime},YOGURTDOWN_Style,,0000,0000,0000,,{{{effect}}}{danmaku.Content}");
        }
